...
.PHONY: setup doctor status progress wait validate validate-rag final-validate final-audit smoke-app benchmark test check run index download docker-up launchd-install launchd-uninstall launchd-status
